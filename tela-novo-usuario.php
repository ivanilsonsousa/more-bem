	...
	<div class="site">
		...
		<form method="POST" action="_controles/processa-cadastro-fornecedor.php">
			...
			<legend id="legenda-end">Tipo de Usuário</legend>
				<div class="tipos">
					<input type="radio" name="tipo" id="adm" value="0"><label id="label-adm" for="adm"> Administrador</label>
					<input type="radio" name="tipo" id="pad" value="1" checked><label id="label-pad" for="pad"> Padrão</label>
				</div>
			</fieldset>
